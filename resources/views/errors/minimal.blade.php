        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p class="fw-personal mb-1 text-success-error-info">Il codice dell'errore è: <u>@yield('code').</u></p>
                    <p class="fw-personal mb-1 text-success-error-info">Questo codice significa che: <u>@yield('message')!</u></p>
