        ...
        <div class="container py-5">
            <div class="row mb-4 mb-lg-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    ...
                    <p class="fw-bold-personal text-success mb-2">Recupera il tuo dolce profilo vegano</p>
                </div>
            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            ...
                            <form id="recoverPassword-form" action="{{route('user.recoverPassword')}}" method="post">
                                @csrf
                                <div>
                                <div class="mb-3"><input class="form-control" type="email" name="username" placeholder="Email"></div>
                                
                                <label for="Login" class="btn btn-log"><i class="bi-check-lg"></i> Richiedi nuova password</label>
